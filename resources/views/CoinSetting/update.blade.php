    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-pencil"></i>金币房配置修改
                </div>
            </div>
                ...
                <form action="#" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="hidden" id="id" class="form-control input-circle input-inline" value="{{$resources->Id}}">
                            </div>
                        </div>
                                    ...
                                    @foreach($v as $key =>$val)
                                        ...
                                        @if($key=='master')
                                            ...
                                            @foreach($val as $kk=>$vv)
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">{{$vv->type}}倍庄</label>
                                                    <div class="col-md-4">
                                                        <input type="hidden" id="id{{$kk+1}}" class="form-control input-circle input-inline" value="{{$vv->type}}">
                                                        <input type="text" id="low{{$kk+1}}" class="form-control input-circle input-inline" value="{{$vv->min}}">-
                                                        <input type="text" id="high{{$kk+1}}" class="form-control input-circle input-inline" value="{{$vv->max}}">
                                                    </div>
                                                </div>
                                            @endforeach
                                        @else
                                            ...
                                            @foreach($val as $kk=>$vv)
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">{{$vv->type}}倍</label>
                                                    <div class="col-md-4">
                                                        <input type="hidden" id="ids{{$kk+1}}" class="form-control input-circle input-inline" value="{{$vv->type}}">
                                                        <input type="text" id="lows{{$kk+1}}" class="form-control input-circle input-inline" value="{{$vv->min}}">-
                                                        <input type="text" id="highs{{$kk+1}}" class="form-control input-circle input-inline" value="{{$vv->max}}">
                                                    </div>
                                                </div>
                                            @endforeach
                                        @endif
                            ...
                            <div id="infoJH">
                                @foreach(json_decode($resources->Config) as $k => $v)
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">上庄MIN</label>
                                        <div class="col-md-4">
                                            <input type="text" id="up" class="form-control input-circle" value="{{$v->up}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">下庄MIN</label>
                                        <div class="col-md-4">
                                            <input type="text" id="down" class="form-control input-circle" value="{{$v->down}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">抽水</label>
                                        <div class="col-md-4">
                                            <input type="text" id="pump" class="form-control input-circle" value="{{$v->pump}}">
                                        </div>
                                    </div>
                                @endforeach
                            </div>
    ...
    $(function(){
        ...
        $("#save").click(function(){
            ...
            $.ajax( {
                ...
                dataType : 'json',
                data : {'_token':'{{csrf_token()}}',id:id,game:game,level:level,rule:rule,status:status},
