                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" id="ShopId" class=" form-control input-circle " value="{{ $res->ShopId }}" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">商品名称</label>
                            <div class="col-md-4">
                                <input type="text" id="name" class=" form-control input-circle " value="{{ $res->name }}" placeholder="商品名称">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                    <div class="mt-repeater">
                                        ...
                                        @foreach(json_decode($res->price,true) as $v)
                                            <div data-repeater-item class="row">
                                                <div class="col-md-3">
                                                    <!-- <label class="control-label">货币数量</label> -->
                                                    <input type="text" name="price_amount" placeholder="货币数量" class="form-control input-circle price_amount" value="{{ $v['amount']}}"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <!-- <label class="control-label">货币类型</label> -->
                                                    <!-- <input type="text" name="price_currency" placeholder="eg:100" class="form-control price_currency" value="{{ $v['currency']}}"/> -->
                                                    <select id="price_currency" class=" form-control input-circle price_currency">
                                                            <option value=""></option>
                                                        @foreach($items as $b)
                                                            <option value="{{ $b->id }}" @if($v['currency']==$b->id) selected @endif>{{ $b->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                               <!--  <div class="col-md-1">
                            ...
                            <div class="col-md-9">
                                    <div class="mt-repeater">
                                        <div data-repeater-list="group-b" id="list_shop">
                                            @foreach(json_decode($res->goods,true) as $v)
                                            <div data-repeater-item class="row">
                                                <div class="col-md-3">
                                                    <!--    <label class="control-label">道具数量</label>
                                                    <input type="text" name="goods_item_count" placeholder="eg:100" class="form-control goods_item_count" value="{{ $v['item_count']}}"/> -->
                                                    <input type="text" name="goods_item_count" placeholder="道具数量" class="form-control input-circle goods_item_count" value="{{ $v['item_count']}}"/>
                                                </div>
                                                <div class="col-md-3">
                                       <!--              <label class="control-label">道具id</label>
                                                    <input type="text" name="goods_item_id" placeholder="eg:100" class="form-control goods_item_id" value="{{ $v['item_id']}}"/> -->
                                                    <select id="goods_item_id" class=" form-control input-circle goods_item_id">
                                                            <option value=""></option>
                                                        @foreach($items as $b)
                                                            <option value="{{ $b->id }}" @if($v['item_id']==$b->id) selected @endif>{{ $b->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                              <!--   <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="index" class=" form-control input-circle " value="{{ $res->index }}" placeholder="显示序号">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">特惠标识</label>
                            <div class="col-md-4">
                                <input type="text" id="discount" class=" form-control input-circle " value="{{ $res->discount }}" placeholder="特惠标识">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <img id="imgUrl" src="{{config('suit.ImgRemoteUrl').$res->icon_name}}" >
                                <input type="hidden"  id="icon_name" class="form-control input-circle" value="{{$res->icon_name}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">苹果id</label>
                            <div class="col-md-4">
                                <input type="text" id="ios_goods_id" class=" form-control input-circle " value="{{ $res->ios_goods_id }}" placeholder="苹果id">
                            </div>
                        </div>
                    </div>
            ...
            $("#save").click(function(){
              ...
              // console.log(award);return false;
                $.ajax( {
                    ...
                    url : "/shop/save",
                    dataType : 'json',
                    data : {'_token':'{{csrf_token()}}',ShopId:ShopId,price:award_o,goods:award_t,id:id,name:name,index:index,discount:discount,icon_name:icon_name,ios_goods_id:ios_goods_id},
                    success : function(data) {
                        if(data.status){
                            alert('编辑成功');
