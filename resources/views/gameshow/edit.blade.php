                ...
                <form action="#" id="myform" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="gameshow_name" class="form-control input-circle" value="{{ $data->gameshow_name }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="allowVersion" class="form-control" >{{ $data->allowVersion }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="denyVersion" class="form-control" >{{ $data->denyVersion }}</textarea>
                                <span class="help-block">  </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="allowChannel" class="form-control" >{{ $data->allowChannel }}</textarea>
                                <span class="help-block">  </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="denyChannel" class="form-control" >{{ $data->denyChannel }}</textarea>
                                <span class="help-block">  </span>
                            </div>
                        </div>
