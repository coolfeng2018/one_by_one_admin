                ...
                <form action="#" id="myform" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="hidden" id="gid"  class="form-control input-circle" value="{{$data['gid']}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"></label>
                            <div class="col-md-4">
                                <input type="hidden" id="pid"  class="form-control input-circle" value="{{$data['pid']}}">
                            </div>
                        </div>
...
<script type="text/javascript">
    $(function(){
        $("#sub").click(function(){
            ...
            $.ajax({
                type : "post",
                url : "/showpieces/savepart",
                dataType : 'json',
                data : {'_token':'{{csrf_token()}}',pid:pid,gid:gid,name:name,num:num,gameid:gameid,type:type,status:status},
