            ...
            <div class="portlet-body">
                    ...
                    <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                        <div class="row">
                            <div class="  input-inline ">
                                <a class="ajaxify btn sbold green" href="/newbieaward/add"> 新增
                ...
                <table id="table" class="table table-striped table-bordered table-hover table-checkable order-column">
                    ...
                    <tr>
                        ...
                        <th> 
                            <input type="checkbox"  name="check_s" onclick="check_s()" value="item_id" id="server_item_id">服务端<br>
                            <input type="checkbox"  name="check_c" onclick="check_c()" value="item_id" id="customer_item_id">客户端 
                        </th>
                        <th> 
                            <input type="checkbox"  name="check_s" onclick="check_s()" value="count" id="server_count">服务端<br>
                            <input type="checkbox"  name="check_c" onclick="check_c()" value="count" id="customer_description">客户端 
                        </th>
                        <th>  
                    ...
                    <div>
                        ...
                        @foreach ($res as $resources)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a class="ajaxify btn sbold green" href="/newbieaward/edit?NewbieAwardId={{ $resources->NewbieAwardId }}"> 修改
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a class="ajaxify btn sbold green" href="/newbieaward/delete?NewbieAwardId={{ $resources->NewbieAwardId }}"> 删除
...
function verify(type){
    ...
    if(type=='server'){
        ...
        //必填项验证end
        url = '/newbieaward/lua?select='+select+'&type=server';
    }else{
        var select = $("#check_customer_data").val();
        if(select==''){
            alert('请至少选择一项');return false;
        }
        url = '/newbieaward/lua?type=customer&select='+select+'&type=customer';
    }
    //异步加载，返回数据拼装
    $.ajax( {
        type : "get",
...
$(function(){
    $("#sntcfg").click(function(){
    	var succesurl = '/newbieaward/index';
    	var select = $("#check_server_data").val();
    	swal({
    	  title: "你确定要发送服务器配置?",
    	  type: "warning",
