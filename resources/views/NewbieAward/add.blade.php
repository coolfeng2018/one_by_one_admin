                ...
                <form action="#" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="id" class=" form-control input-circle " value="" placeholder="id">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="count" class=" form-control input-circle " value="" placeholder="数量">
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
        $(function(){
            ...
            $("#save").click(function(){
                //ajax提交
                var NewbieAward= $("#NewbieAward").val();
                var id= $("#id").val();
                ...
                $.ajax( {
                    ...
                    dataType : 'json',
                    data : {'_token':'{{csrf_token()}}',NewbieAward:NewbieAward,id:id,item_id:item_id,count:count},
