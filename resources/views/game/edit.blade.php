<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red-sunglo bold uppercase">修改游戏</span>
    ...
    <div class="portlet-body form">
        ...
        <form action="" id="myform" class="form-horizontal" method="post">
            {{ csrf_field() }}
            <input name="game_id" type="hidden" value="{{ $data->game_id }}">
            <div class="form-body">
                <div class="form-group">
                    <label class="col-md-3 control-label">游戏名称</label>
                    <div class="col-md-4">
                        <input name="game_name" type="text" class="form-control" placeholder="游戏名称" value="{{ $data->game_name }}">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="game_type" type="text" class="form-control" placeholder="游戏类型" value="{{ $data->game_type }}">
                        <span class="help-block">  </span>
                    </div>
                </div>
            </div>
