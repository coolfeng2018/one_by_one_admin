                ...
                <form action="#" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="stime" class="form-control input-circle" value="{{$res['gift']['stime']}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="etime" class="form-control input-circle" value="{{$res['gift']['etime']}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="price" class="form-control input-circle" value="{{$res['gift']['price']}}">
                            </div>
                        </div>
