                ...
                <form action="#" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="title" class=" form-control input-circle " value="" placeholder="标题">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">描述</label>
                            <div class="col-md-4">
                                <input type="text" id="des" class=" form-control input-circle " value="" placeholder="描述">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">URL</label>
                            <div class="col-md-4">
                                <input type="text" id="targetUrl" class=" form-control input-circle " value="" placeholder="URL">
                            </div>
                        </div>
                       <!--  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="shareImg" class=" form-control input-circle " value="" placeholder="分享图片和链接">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">分享类型</label>
                            <div class="col-md-4">
                                <input type="text" id="sharetype" class=" form-control input-circle " value="" placeholder="分享类型">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">那种分享</label>
                            <div class="col-md-4">
                                <input type="text" id="sharetab" class=" form-control input-circle " value="" placeholder="那种分享">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">任务分享标题</label>
                            <div class="col-md-4">
                                <input type="text" id="task_share_title" class=" form-control input-circle " value="" placeholder="任务分享标题">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">任务分享内容</label>
                            <div class="col-md-4">
                                <input type="text" id="task_share_content" class=" form-control input-circle " value="" placeholder="任务分享内容">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">任务分享链接</label>
                            <div class="col-md-4">
                                <input type="text" id="task_share_url" class=" form-control input-circle " value="" placeholder="任务分享链接">
                            </div>
                        </div>
                    </div>
