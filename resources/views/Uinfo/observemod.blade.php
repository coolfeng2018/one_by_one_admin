        ...
        <form class="form-horizontal" method="post" id="myform">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="uid" name="uid" class="form-control input-inline input-medium"  value="{{$data->uid}}" readonly>
                ...
                <div class="form-group">  
                    ...
                    <div class="col-md-9">
                    	<select class="bs-select form-control  input-medium " id="otype" name="otype">
                            ...
                            <option value='{{$key}}' @if($data->otype ==$key) selected  @endif >{{$val}}</option>
                            @endforeach   
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="percent" name="percent" class="form-control input-inline input-medium"   value="{{$data->percent}}" >
				...
				<div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="goal_num" name="goal_num" class="form-control input-inline input-medium"   value="{{$data->goal_num}}" >
...
$(function(){
    $("#save").click(function(){
        var url = "{{sprintf($actions['observemod'],$page)}}";
