        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> 管理员 -渠道权限分配 </span>
                </div>
            </div>
                ...
                <div class="table-toolbar">
                    <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                        <div class="  input-inline ">
                            <a class="ajaxify btn sbold green" href="/manage/index?page={{$page}}"> 返回管理员管理
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-5 col-md-7">
                                ...
                                <a type="button" id="cancel" class="btn sbold grey ajaxify" href="/manage/index?page={{$page}}"> 取消</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    $(function(){
        $("#save").click(function(){
            ...
            $.ajax( {
                    type : "get",
                    url : "/manage/cidfliter?act=do&mypro="+mypro+"&id="+id,
                    dataType : 'json',
