                ...
                <form action="#" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="ID" class=" form-control input-circle " value="" placeholder="广播ID">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">广播内容</label>
                            <div class="col-md-4">
                                <input type="text" id="content" class=" form-control input-circle " value="" placeholder="广播内容">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">最小间隔</label>
                            <div class="col-md-4">
                                <input type="text" id="min_time" class=" form-control input-circle " value="" placeholder="最小间隔">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">最大间隔</label>
                            <div class="col-md-4">
                                <input type="text" id="max_time" class=" form-control input-circle " value="" placeholder="最大间隔">
                            </div>
                        </div>
                    </div>
