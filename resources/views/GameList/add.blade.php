                ...
                <form action="#" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="id" class=" form-control input-circle " value="" placeholder="大厅位置排序">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select id="game_type_name" class=" form-control input-circle input-inline">
                                    ...
                                    @foreach($datagame as $v)
                                        <option value="{{ $v->game_type }}" valuename="{{ $v->game_name }}">{{ $v->game_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <img id="imgUrl" src="" >
                                <input type="hidden"  id="icon" class="form-control input-circle" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select id="shown_type" class=" form-control input-circle input-inline">
                                    ...
                                    <option value="2">私人房</option>
                                    <option value="3">快速开始</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
