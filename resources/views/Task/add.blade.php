                ...
                <form action="#" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select id="type" class=" form-control input-circle input-inline">
                                    ...
                                    <option value="2">周常任务</option>
                                    <option value="3">月常任务</option>
                                    <option value="4">每日首次分享</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="param" class=" form-control input-circle " value="" placeholder="参数">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select id="game_type" class=" form-control input-circle input-inline">
                                    ...
                                    @foreach($datagame as $v)
                                        <option value="{{ $v->game_type }}">{{ $v->game_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select id="cycle" class=" form-control input-circle input-inline">
                                    <option value=""></option>
                                    <option value="1">对局数</option>
                                    <option value="2">赢局数</option>
                                    <option value="3">拿到指定牌型次数</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="process" class=" form-control input-circle " value="" placeholder="总体进度">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">任务名称</label>
                            <div class="col-md-4">
                                <input type="text" id="name" class=" form-control input-circle " value="" placeholder="任务名称">
                            </div>
                        </div>
                        <div class="form-group">
                                        ...
                                        <div data-repeater-list="group-b" id="list">
                                            <div data-repeater-item class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="award_list_id" placeholder="eg:100" class="form-control award_list_id" value=""/>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="control-label">奖励数量</label>
                                                    <input type="text" name="award_list_count" placeholder="eg:100" class="form-control award_list_count" value=""/>
                                                </div>
                                                <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="next_id" class=" form-control input-circle " value="" placeholder="下一个任务id">
                            </div>
                        </div>
                    </div>
