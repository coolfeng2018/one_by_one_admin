    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <i class="icon-rocket font-dark"></i>
                    <span class="caption-subject bold uppercase"> 道具列表 </span>
                </div>
            </div>
            <div class="portlet-body">
                    ...
                    <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                        <div class="row">
                            <div class="  input-inline ">
                                <a class="ajaxify btn sbold green" href="/item/add"> 新增
                ...
                <table id="table" class="table table-striped table-bordered table-hover table-checkable order-column">
                    <thead>
                    <tr>
                        <th width="160px"> 道具id </th>
                        <th width="160px"> 名字 </th>
                        <th width="160px"> 描述 </th>
                        <th width="160px"> icon </th>
                    ...
                    <tr>
                        ...
                        <th> 
                            <input type="checkbox"  name="check_s" onclick="check_s()" value="description" id="server_description">服务端<br>
                            <input type="checkbox"  name="check_c" onclick="check_c()" value="description" id="customer_description">客户端 
                        </th>
                        <th> 
                    ...
                    <div>
                        ...
                        @foreach ($res as $resources)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a class="ajaxify btn sbold green" href="/item/edit?ItemId={{ $resources->ItemId }}"> 修改
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a class="ajaxify btn sbold green" href="/item/delete?ItemId={{ $resources->ItemId }}"> 删除
...
function verify(type){
    ...
    if(type=='server'){
        ...
        //必填项验证end
        url = '/item/lua?select='+select+'&type=server';
    }else{
        var select = $("#check_customer_data").val();
        if(select==''){
            alert('请至少选择一项');return false;
        }
        url = '/item/lua?type=customer&select='+select+'&type=customer';
    }
    //异步加载，返回数据拼装
    $.ajax( {
        type : "get",
