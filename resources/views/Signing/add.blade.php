                ...
                <form action="#" class="form-horizontal" method="post">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="month" class=" form-control input-circle " value="" placeholder="连续签到天数">
                            </div>
                        </div>
                        <div class="form-group">
                                        ...
                                        <div data-repeater-list="group-b" id="list">
                                            <div data-repeater-item class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="awards_list_id" placeholder="eg:100" class="form-control awards_list_id" value=""/>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="control-label">奖励数量</label>
                                                    <input type="text" name="awards_list_count" placeholder="eg:100" class="form-control awards_list_count" value=""/>
                                                </div>
                                                <div class="col-md-1">
