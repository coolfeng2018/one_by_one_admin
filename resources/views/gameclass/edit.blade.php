<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red-sunglo bold uppercase">修改分类</span>
        ...
        <form action="" id="myform" class="form-horizontal" method="post">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="class_name" type="text" class="form-control" placeholder="Enter text" value="{{ $data->class_name}}">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="class_sort" type="text" class="form-control" value="{{ $data->class_sort }}" >
                        <span class="help-block">  </span>
                    </div>
                </div>
            </div>
