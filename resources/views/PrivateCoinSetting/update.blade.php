                    ...
                    <div class="form-body">
                        ...
                        <div class="base">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" id="base" class="form-control input-circle" value="{{ $res['base']}}">
                                </div>
                            </div>
                        </div>
                        <hr/>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#save").click(function(){
            ...
            var reg=/^\d+$/
            if(!reg.test(score) || !reg.test(card) || !reg.test(max)){
                alert('基础信息必须为数字');
                return false;
            }
            ...
            $.ajax( {
                type : "post",
                url : "/privateCoinSetting/save",
                dataType : 'json',
                data : {'_token':'{{csrf_token()}}',id:id,score:score,card:card,max:max,base:base,ptype:ptype,plist:plist,atype:atype,alist:alist},
