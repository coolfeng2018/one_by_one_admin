<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red-sunglo bold uppercase">添加破产补助方案</span>
    ...
    <div class="portlet-body form">
        ...
        <form action="" id="myform" class="form-horizontal" method="post">
            {{ csrf_field() }}
            <input name="bankruptcy_id" type="hidden" value="0">
            <div class="form-body">
                <div class="form-group">
                    <label class="col-md-3 control-label">方案名称</label>
                    <div class="col-md-4">
                        <input name="bankruptcy_name" type="text" class="form-control" placeholder="Enter text">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="below" type="text" class="form-control" placeholder="Enter text">
            ...
            <div class="form-body">
                <div class="form-group" >
                    ...
                    <div class="col-md-4">
                        <input name="number" type="text" class="form-control" placeholder="Enter text">
                        <span class="help-block"></span>
                    </div>
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="amount" type="text" class="form-control" placeholder="Enter text">
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
